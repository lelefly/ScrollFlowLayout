 ...
 * 添加了限制两行并且每一行水平居中
 */
public class JLFlowLayout extends ViewGroup {

    private OnFillCallback onFillCallback;

    public JLFlowLayout(Context context) {
        super(context);
    }

    public JLFlowLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
